document.addEventListener('DOMContentLoaded', () => {
    ...
    //         throw new Error(errorData.error || errorData.mensaje || 'Error al obtener los productos');
    //     }
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-end align-items-center pt-2">
                                <div class="rounded-pill">
                                    <button type="button" class="delete btn btn-sm btn-outline-danger rounded-pill" data-id="${producto.id}">Eliminar</button>
                                    <button type="button" class="update btn btn-sm btn-outline-primary rounded-pill" data-id="${producto.id}" data-sku="${producto.sku}" data-titulo="${producto.titulo}" data-descripcion="${producto.descripcion}" data-precio="${producto.precio}" data-bs-toggle="modal" data-bs-target="#editProduct">Editar</button>
                                </div>
                            </div>
                        </div>
                    </div>

                    <div class="modal fade" id="${producto.sku}" data-bs-backdrop="static" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
                            <div class="modal-content">
                                <div class="modal-header">
